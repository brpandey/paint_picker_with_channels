...
var _user$project$PaintPickerWithChannels$main = _elm_lang$html$Html$beginnerProgram(
	{model: _user$project$PaintPickerWithChannels$init, update: _user$project$PaintPickerWithChannels$update, view: _user$project$PaintPickerWithChannels$view})();

var Elm = {};
Elm['PaintPickerWithChannels'] = Elm['PaintPickerWithChannels'] || {};
if (typeof _user$project$PaintPickerWithChannels$main !== 'undefined') {
    _user$project$PaintPickerWithChannels$main(Elm['PaintPickerWithChannels'], 'PaintPickerWithChannels', undefined);
}
